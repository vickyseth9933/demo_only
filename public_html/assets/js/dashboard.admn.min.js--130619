...
$( document ).ready(function() {
    ...
    var plotObj = $.plot($("#dash_pie_totaljobs"), data_total_review_jobs, {
        series: {
            pie: {
                show: true
            }
    ...
    var data_form_stages = [{
        label: "CoverSheet", data:CoverSheet_jobs_cnt, color: "#bdc3c7", }, {
        label: "ProjectDetails", data: PrjDetails_jobs_cnt, color: "#43AEA8", }, {
        label: "QualifyFive", data: QualifyFive_jobs_cnt, color: "#999933", }, {
        label: "DistributnChkklist", data: DistributnChkklist_jobs_cnt, color: "#AED6F1", }
       ];
    var plotObj = $.plot($("#dash_pie_formstage"), data_form_stages, {
        series: {
            pie: {  show: true }
        },
        grid: { hoverable: true },
