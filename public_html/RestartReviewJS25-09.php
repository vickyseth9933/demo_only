...
echo $query1 = "SELECT id FROM cb_front_cover WHERE order_id='$order_no' AND user_id='$id'";
...
if($rowcount_cb_front_cover == 0){
     echo  $sql_cb_front_cover = "INSERT INTO cb_front_cover SET distribution_transmission='".$row['TRANS_DIST']."',foreman='".$row['FOREMAN']."',city='".$row['CITY']."',project_id='".$row['PROJECTID']."',reviewerlanid = '".$row['lanid']."', dateofreview = '".$row['created_on']."', division = '".$row['division']."', resp_group = '".$row['RESPONSIBLE_GROUP']."', order_description = '".$row['description']."',order_id = $order_no,user_id='$id'";	
 $conn->query($sql_cb_front_cover);
}
if($rowcount_cb_project_details == 0){
    //$sql_cb_project_details = "INSERT INTO cb_project_details (order_id,user_id,mat,cn24,cn07,cn07_date,cn29,cn29_date) VALUES ('$order_no','$id','".$row['mat']."','".$row['cn24']."','".$row['cn07']."','".$row['cn07_date']."','".$row['cn29']."','".$row['cn29_date']."')";
     //  $sql_cb_project_details = "INSERT INTO cb_project_details (order_id,user_id,mat,cn24,cn24_date,cn07,cn07_date,cn29,cn29_date,dc39_date,dc46_date,dc05_date,dc14_date,dc15_date,dc19_date,dc10_date) VALUES ('$order_no','$id','".$row['mat']."','".$row['cn24']."','".$CN24_SAP_DATE."','".$row['cn07']."','".$CN07_SAP_DATE."','".$row['cn29']."','".$CN29_SAP_DATE."','".$DC39_SAP_DATE."','".$DC46_SAP_DATE."','".$DC05_SAP_DATE."','".$DC14_SAP_DATE."','".$DC15_SAP_DATE."','".$DC19_SAP_DATE."','".$DC10_SAP_DATE."')";
...
if($rowcount_qualiflying_five == 0){
 ...
 $conn->query($sql_cb_qualiflying_five);
}
if($rowcount_distribution_checklist == 0){
 ...
 $conn->query($sql_cb_distribution_checklist);
}
 ?>