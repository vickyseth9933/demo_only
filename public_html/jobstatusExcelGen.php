...
$conn = OpenCon();
$todaydate = date('his');
$filename = $todaydate."JobStatus.xls"; // File Name
// Download file
header("Content-Disposition: attachment; filename=\"$filename\"");
header("Content-Type: application/vnd.ms-excel");
$user_query = mysqli_query($conn,'SELECT cb_order_new.order_no,cb_order_new.order_stage,cb_order_new.approved_date,cb_user.first_name,cb_user.last_name,cb_user.lanid,cb_user.city,cb_front_cover.project_id,cb_front_cover.dateofreview as created_on,cb_front_cover.reviewcompletiondate,cb_front_cover.order_description as description,cb_front_cover.resp_group,cb_front_cover.division,cb_front_cover.city as city_name,cb_front_cover.cn_29_eligible,cb_front_cover.fc_cm,cb_front_cover.ce_rcm,cb_front_cover.foreman,cb_front_cover.m_c_supervisor,cb_front_cover.distribution_transmission,cb_front_cover.inspector,
...
WHERE cb_order_new.order_stage NOT IN(5)');
// Write data to file
$flag = false;
