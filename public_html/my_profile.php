...
if(isset($_POST)){
    ...
    $reviewer_hire_date = mysqli_real_escape_string($conn, date('Y-m-d',strtotime($_POST['hire_date'])));
    ...
    $sql_UsrProfile = "UPDATE cb_user SET first_name = '$reviewer_fname',last_name = '$reviewer_lname', email = '$reviewer_email',lanid = '$reviewer_lanid',phone = $reviewer_phone,password = '$Password',state = '$reviewer_state',city = '$reviewer_city',zip = '$reviewer_zip',hire_date = '$reviewer_hire_date',profile_image = '$uploaded_file' WHERE id = $userid";
        ...
        if($Password==''){
            $sql_UsrProfile = "UPDATE cb_user SET first_name = '$reviewer_fname',last_name = '$reviewer_lname', email = '$reviewer_email',lanid = '$reviewer_lanid',phone = $reviewer_phone,state = '$reviewer_state',city = '$reviewer_city',zip = '$reviewer_zip',hire_date = '$reviewer_hire_date' WHERE id = $userid";
                ...
                $sql_UsrProfile = "UPDATE cb_user SET first_name = '$reviewer_fname',last_name = '$reviewer_lname', email = '$reviewer_email',lanid = '$reviewer_lanid',phone = $reviewer_phone,password = '$Password',state = '$reviewer_state',city = '$reviewer_city',zip = '$reviewer_zip',hire_date = '$reviewer_hire_date' WHERE id = $userid";
                                            ...
                                            <div class="card">
                                                <div class="card-block">
                                                    ...
                                                    <?php if($user_profile_image){ ?>
                                                        <!--<img src="file_image;?>" class="img-circle" width="150">-->
                                                        <img src="/profile_image/<?php echo $user_profile_image;?>" class="img-circle" width="150">
                                                        ...
                                                        <div class="media-body">
                                                            <ul class="list-unstyled list-info">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a href="http://maps.google.com/?q=<?= $user_address ?>"  target="_blank"><?php if(isset($user_address)){
                                                                        echo $user_address;
                                                                    } ?></a>
                                                                </li>
                                                                <li>
