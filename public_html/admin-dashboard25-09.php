...
$userid = $_SESSION['userid'];
    $sql = "SELECT cb_order_new.order_no,cb_order_new.recommendation,cb_order_new.user_id,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,cb_front_cover.dateofreview,
...
$sqljobstatus = "SELECT cb_order_new.order_no,cb_order_new.recommendation,cb_order_new.user_id,cb_order_new.RESPONSIBLE_GROUP,cb_order_new.mat as MAAT,cb_order_new.description as Discriptions,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat FROM cb_order_new 
INNER JOIN cb_user ON(cb_order_new.user_id=cb_user.id)
LEFT JOIN cb_front_cover ON(cb_front_cover.order_id=cb_order_new.order_no)
LEFT JOIN cb_project_details ON(cb_project_details.order_id=cb_order_new.order_no)
                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
										...
										<div class="flexbox control-div mb-2">
											<div class="flexbox">
												...
												<select class="selectpicker show-tick form-control selectpickerdiv2" id="type-filter" title="Please select" data-style="btn-solid" data-width="150px">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <th>MAT</th>
                                                 <th>Current Stage</th>
                                                 <th>Job Status</th>
                                                 <th style="width:350px !important">Recommendation</th>
                                                 <th>Action</th>
