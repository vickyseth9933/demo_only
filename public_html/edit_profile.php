...
if ($result_UsrProfile->num_rows > 0) {
    ...
    {
       $user_hire_date = date('m/d/Y',strtotime($UsrProfile_res['hire_date']));
    } else {
      $user_hire_date = '';
    }
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <ul _ngcontent-c12="" class="timeline">
                                            ...
                                            <li class="timeline-item01"><i _ngcontent-c12="" class="fa fa-map-marker timeline-icon"></i><a href="http://maps.google.com/?q=<?= $user_address ?>"  target="_blank"><?= $user_address ?></li></a>
                                            <li class="timeline-item01"><i _ngcontent-c12="" class="fa fa-envelope timeline-icon"></i> <a _ngcontent-c12=""  href="mailto:<?=$user_email ?>"><?= $user_email ?></a></li>
                                           <li class="timeline-item01"><i _ngcontent-c12="" class="fa fa-phone timeline-icon"></i><a _ngcontent-c12=""  href="tel:<?=$user_phone ?>"><?= $user_phone ?></a></li>
                                            ...
                                            <div class="row">
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                                     <label>First Name</label><input class="form-control required" id="fname" name="firstName" type="text" value="<?= htmlentities($user_fname, ENT_QUOTES) ?>">
                                                  </div>
                                               </div>
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                                     <label>Last Name</label><input class="form-control required" id="lname" name="lastName" value="<?= htmlentities($user_lname, ENT_QUOTES) ?>">
                                                  </div>
                                               </div>
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                                     <label>Email</label><input class="form-control required" readonly name="email" id="email" type="email" value="<?= htmlentities($user_email, ENT_QUOTES) ?>">
                                                  </div>
                                               </div>
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                                     <label>LAN ID</label><input class="form-control required" name="lanid" type="text" value="<?= htmlentities($user_lanid, ENT_QUOTES) ?>">
                                                  </div>
                                               </div>
                                               <div class="col-md-4">
                                                    <div class="form-group">
                                                       <label>Phone</label><input class="form-control required" name="phone" id="phn" type="Number" value="<?= htmlentities($user_phone, ENT_QUOTES) ?>">
                                                    </div>
                                                 </div>
                                               <div class="col-md-4">
                                                   <div class="form-group">
                                                     <label>Password</label><input class="form-control "  name="Password" id="Password" placeholder="Enter Password" type="Password">
                                                  </div>
                                               </div>
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                                     <label>City</label><input class="form-control" name="city" placeholder="Your City" type="text" value="<?= htmlentities($user_city, ENT_QUOTES) ?>">
                                                  </div>
                                               </div>
                                               
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                                     <label>Zip Code</label><input class="form-control" name="zip" placeholder="Your Zip Code" type="text" value="<?= htmlentities($user_zip, ENT_QUOTES) ?>">
                                                  </div>
                                               </div>
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                               ...
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                                     <label>State</label><input class="form-control" name="state" placeholder="Your State" type="text" value="<?= htmlentities($user_state, ENT_QUOTES) ?>">
                                                  </div>
                                               </div>
                                               <div class="col-md-4">
                                                  <div class="form-group">
                                               ...
                                               <div class="col-md-4">
                                                  <div class="form-group"><label>Hire Date</label><input class="form-control " readonly id="" name="hire_date" type="text" value="<?= $user_hire_date; ?>"></div>
                                               </div>
