...
//insert order data for cross bore 
			...
			if(empty($rowData[0][29])){
			    $CN24_SAP_DATE = '';
			     ...
			     $CN24_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][29])));
			}
            ...
            if(empty($rowData[0][33])){
			    $CN29_SAP_DATE = '';
			} else {
			   
			     //$CN29_SAP_DATE=isset($rowData[0][33])? $rowData[0][33] : 'N/A';
                $CN29_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][33])));
			}
            
            
            $CN29_BY_SAP=isset($rowData[0][34])? $rowData[0][34] : 'N/A';
            
            if(empty($rowData[0][35])){
			     $CN07_SAP_DATE = '';
			} else {
			  
			     //$CN07_SAP_DATE=isset($rowData[0][35])? $rowData[0][35] : 'N/A';
                $CN07_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][35])));
			}
            ...
            if(empty($rowData[0][38])){
			    $DC39_SAP_DATE = '';
			} else {
			   
			     //$DC39_SAP_DATE=isset($rowData[0][38])? $rowData[0][38] : 'N/A';
                $DC39_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][38])));
			}
           
            
            
            //$DC39_BY_SAP = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][39])));
            $DC39_BY_SAP=isset($rowData[0][39])? $rowData[0][39] : 'N/A';
            
            if(empty($rowData[0][40])){
			   $DC46_SAP_DATE = '';
			} else {
			    
			     $DC46_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][40])));
            ...
            if(empty($rowData[0][42])){
			      $DC05_SAP_DATE = '';
			} else {
			  
			     //$DC05_SAP_DATE=isset($rowData[0][42])? $rowData[0][42] : 'N/A';
                 $DC05_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][42])));
			}
            ...
            if(empty($rowData[0][44])){
			     $DC14_SAP_DATE = '';
			} else {
			   
			      //$DC14_SAP_DATE=isset($rowData[0][44])? $rowData[0][44] : 'N/A';
                  $DC14_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][44])));
			}
           
            
            $DC14_BY_SAP=isset($rowData[0][45])? $rowData[0][45] : 'N/A';
            
            if(empty($rowData[0][46])){
			     $DC15_SAP_DATE = '';
			} else {
			    
			    //$DC15_SAP_DATE=isset($rowData[0][46])? $rowData[0][46] : 'N/A';
                 $DC15_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][46])));
			}
            ...
            if(empty($rowData[0][48])){
			        $DC19_SAP_DATE = '';
			} else {
			        //$DC19_SAP_DATE=isset($rowData[0][48])? $rowData[0][48] : 'N/A';
                   $DC19_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][48])));
			}
            ...
            if(empty($rowData[0][50])){
			       $DC10_SAP_DATE = '';
			} else {
			        //$DC10_SAP_DATE=isset($rowData[0][50])? $rowData[0][50] : 'N/A';
                    $DC10_SAP_DATE = date('Y-m-d', PHPExcel_Shared_Date::ExcelToPHP(trim($rowData[0][50])));
			}
