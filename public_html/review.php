                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form id="form-wizard" action="javascript:;" method="post" novalidate="novalidate" class="mform stepForm">
                                        ...
                                        <section>
                                            <h3>Cover Sheet</h3>
                                            <div class="row" id="cover_sheet">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label">Reviewer LANID</label>
                                                        <div class="col-sm-7">
                                                            <input type="text" value="<?= htmlentities($row['lanid'], ENT_QUOTES); ?>" id="lanid" realtime="reviewerlanid" onInput="validatelanid()"  class="form-control" placeholder="">
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <?php
															if($row['created_on']=='0000-00-00' || $row['created_on']=='' || $row['created_on']==null){
															$cur_date = date("m/d/Y");	
															}
															else{
															$cur_date = date('m/d/Y',strtotime($row['created_on'])); 	
															}

															?>
                                                            <input type="text" realtime="dateofreview" readonly  value="<?php echo $cur_date;?>" id="review_date" class="form-control">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="reviewcompletiondate" placeholder="MM/DD/YYYY" value="<?php if($row['approved_date']=='00/00/0000' || $row['approved_date']==null){ echo '';  }else{ echo  $row['approved_date']; } ; ?>" id="review_completion_date" disabled class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label">Order Number</label>
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="order_id" readonly value="<?= $row['order_no']; ?>" id="order_no" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label">Project ID</label>
                                                        <div class="col-sm-7">
                                                            <input type="text" value="<?= htmlentities($row['project_id'], ENT_QUOTES); ?>" id="project_id" realtime="project_id" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="division" value="<?= htmlentities($row['division'], ENT_QUOTES); ?>" id="division" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="city" value="<?= htmlentities($row['city_name'], ENT_QUOTES); ?>" id="city" class="form-control">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">                                                   
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <textarea type="text" realtime="order_description" value="<?= htmlentities($row['description'], ENT_QUOTES); ?>" id="order_description" class="form-control"><?= htmlentities($row['description'], ENT_QUOTES); ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="fc_cm" value="<?= htmlentities($row['fc_cm'], ENT_QUOTES); ?>" id="FE_CM" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label">CE/RCM</label>
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="ce_rcm" value="<?= htmlentities($row['ce_rcm'], ENT_QUOTES); ?>" id="CE_RCM" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label">Foreman</label>
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="foreman" value="<?= htmlentities($row['foreman'], ENT_QUOTES); ?>" id="foreman" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label">M&C Supervisor</label>
                                                        <div class="col-sm-7">
                                                            <input type="text" realtime="m_c_supervisor" value="<?= htmlentities($row['m_c_supervisor'], ENT_QUOTES); ?>" id="m_c_supervisor" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-5 col-form-label">Distribution/Transmission</label>
                                                        <div class="col-sm-7">
                                                            <select realtime="distribution_transmission" class="form-control valid" aria-invalid="false" id="Distribution_Transmission">
                                                                <?php if($row['distribution_transmission'] == ''){ ?>
                                                                <option value="">Please Select</option>
                                                                  <?php   } ?>
                                                              <option value="Distribution"<?php if(strtolower($row['distribution_transmission']) == 'distribution'): ?> selected="selected"<?php endif; ?>>Distribution</option>
                                                              <option value="Transmission"<?php if(strtolower($row['distribution_transmission']) == 'transmission'): ?> selected="selected"<?php endif; ?>>Transmission</option>
                                                            </select>
                                                        </div>
                                                    </div>  
                                                     ...
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select realtime="resp_group" class="form-control valid" aria-invalid="false" id="resp_gp">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>MAT</label>
                                                                <input type="text" realtime="mat" value="<?= htmlentities($row['mat'], ENT_QUOTES); ?>" id="mat" class="form-control">
                                                                <span>&nbsp;</span>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" realtime="MAT_check" value="" <?php if($row['MAT_check'] == 'true'): ?> checked="checked"<?php endif; ?> class="custom-control-input" id="MAT_check">
                                                                    <label class="custom-control-label" for="MAT_check"></label>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <select realtime="cn24" class="form-control" id="cn24">
                                                                    <?php if($row['cn24'] == '' || $row['cn24'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  realtime="cn24_lanid" type="text"  value="<?= htmlentities($row['cn24_lanid'], ENT_QUOTES); ?>" id="cn24_lanid" class="form-control" placeholder="LAN ID">
                                                             </span>
                                                                <span class="inlineInput">
                                                                <input  realtime="CN24_SAP_DATE" type="text" value="<?= htmlentities($row['CN24_SAP_DATE'], ENT_QUOTES); ?>" id="cn24_date" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" placeholder="MM/DD/YYYY">
                                                             </span>
                                                                <span>&nbsp;</span>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input realtime="CN24_check" type="checkbox" value="" <?php if($row['CN24_check'] == 'true'): ?> checked="checked"<?php endif; ?> id="CN24_check" class="custom-control-input">
                                                                    <label class="custom-control-label" for="CN24_check"></label>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>CN29</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn29" class="form-control" id="cn29">
                                                                    <?php if($row['cn29'] == '' || $row['cn29'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input realtime="cn29_lanid" value="<?= htmlentities($row['cn29_lanid'], ENT_QUOTES); ?>" id="cn29_lanid" type="text" class="form-control" placeholder="LAN ID">
                                                             </span>
                                                                ...
                                                                <input  realtime="CN29_SAP_DATE" type="text" value="<?php if(htmlentities($row['CN29_SAP_DATE'], ENT_QUOTES)!='0000-00-00'){ echo htmlentities($row['CN29_SAP_DATE'], ENT_QUOTES); } ?>" id="cn29_date"  class="form-control datepicker" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" placeholder="MM/DD/YYYY">
                                                             </span>
                                                                <span>&nbsp;</span>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input realtime="CN29_check" type="checkbox" value="" <?php if($row['CN29_check'] == 'true'): ?> checked="checked"<?php endif; ?> class="custom-control-input" id="CN29_check">
                                                                    <label class="custom-control-label" for="CN29_check"></label>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>CN07</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn07" class="form-control" id="cn07">
                                                                    <?php if($row['cn07'] == '' || $row['cn07'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input realtime="cn07" type="text" class="form-control" value="<?= htmlentities($row['cn07_lanid'], ENT_QUOTES); ?>" id="cn07_lanid" placeholder="LAN ID">
                                                             </span>
                                                                <span class="inlineInput">
                                                                <input realtime="cn07" type="text" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" value="<?php if(htmlentities($row['CN07_SAP_DATE'], ENT_QUOTES)!='0000-00-00'){ echo htmlentities($row['CN07_SAP_DATE'], ENT_QUOTES); } ?>" id="cn07_date" placeholder="MM/DD/YYYY">
                                                             </span>
                                                                <span>&nbsp;</span>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input realtime="cn07" type="checkbox" value="" <?php if($row['CN07_check'] == 'true'): ?> checked="checked"<?php endif; ?> class="custom-control-input" id="CN07_check">
                                                                    <label class="custom-control-label" for="CN07_check"></label>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>DC 39</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn07" class="form-control" id="dc39">
                                                                    <?php if($row['dc39'] == '' || $row['dc39'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" class="form-control" value="<?= htmlentities($row['dc39_lanid'], ENT_QUOTES) ?>" id="dc39_lanid" placeholder="LAN ID">
                                                             </span>
                                                             <span class="errorcls" id="errorcnlanid" style="display:none;">Please enter lanid for CN07</span>
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" value="<?= htmlentities($row['dc39_date'], ENT_QUOTES); ?>" id="dc39_date" placeholder="MM/DD/YYYY">
                                                             </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>DC 46</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn07" class="form-control" id="dc46">
                                                                    <?php if($row['dc46'] == '' || $row['dc46'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" class="form-control" value="<?= htmlentities($row['dc46_lanid'], ENT_QUOTES); ?>" id="dc46_lanid" placeholder="LAN ID">
                                                             </span>
                                                                <span class="inlineInput">
                                                                <input realtime="cn07" type="text" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" value="<?= htmlentities($row['dc46_date'], ENT_QUOTES); ?>" id="dc46_date" placeholder="MM/DD/YYYY">
                                                             </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>DC 05</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn07" class="form-control" id="dc05">
                                                                    <?php if($row['dc05'] == '' || $row['dc05'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" class="form-control" value="<?= htmlentities($row['dc05_lanid'], ENT_QUOTES); ?>" id="dc05_lanid" placeholder="LAN ID">
                                                             </span>
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" value="<?= htmlentities($row['dc05_date'], ENT_QUOTES); ?>" id="dc05_date" placeholder="MM/DD/YYYY">
                                                             </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>DC 14</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn07" class="form-control" id="dc14">
                                                                    <?php if($row['dc14'] == '' || $row['dc14'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" class="form-control" value="<?= htmlentities($row['dc14_lanid'], ENT_QUOTES); ?>" id="dc14_lanid" placeholder="LAN ID">
                                                             </span>
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" value="<?= htmlentities($row['dc14_date'], ENT_QUOTES); ?>" id="dc14_date" placeholder="MM/DD/YYYY">
                                                             </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>DC 15</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn07" class="form-control" id="dc15">
                                                                     <?php if($row['dc15'] == '' || $row['dc15'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input realtime="cn07" type="text" class="form-control" value="<?= htmlentities($row['dc15_lanid'], ENT_QUOTES); ?>" id="dc15_lanid" placeholder="LAN ID">
                                                             </span>
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" value="<?= htmlentities($row['dc15_date'], ENT_QUOTES); ?>" id="dc15_date" placeholder="MM/DD/YYYY">
                                                             </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                <label>DC 19</label>
                                                                <span class="inlineInput">
                                                                <select realtime="cn07" class="form-control" id="dc19">
                                                                     <?php if($row['dc19'] == '' || $row['dc19'] == 'N/A'){ ?>
                                                                    <option value="">Please Select</option>
                                                                    <?php   } ?>
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" class="form-control" value="<?= htmlentities($row['dc19_lanid'], ENT_QUOTES); ?>" id="dc19_lanid" placeholder="LAN ID">
                                                             </span>
                                                                <span class="inlineInput">
                                                                <input  realtime="cn07" type="text" data-date="MM-DD-YYYY" data-date-format="MM-DD-YYYY" class="form-control datepicker" value="<?= htmlentities($row['dc19_date'], ENT_QUOTES); ?>" id="dc19_date" placeholder="MM/DD/YYYY">
                                                             </span>
                                                            </div>
                                                        </div>
                                                    </div>
...
"><?php echo htmlentities($row['Post_Inspection_Required_per_PRE_Inspection_cmt'], ENT_QUOTES); ?></textarea>
                                            ...
                                            <div class="row padd-div">
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group class-color_div">
                                                        <textarea id="Cross_Bore_Log_cmt" class="form-control" rows="2"   placeholder=" Yes, Pre & Post Cross Bore Logs present.&#13;&#10; No,Post Logs not found in SAP and required per PRE-Inspection Logs."><?= $row['Cross_Bore_Log_cmt'] ?></textarea>
                                                        <span class="errorcmt" id="errorcmt" style="display:none;color:red;">Please enter your comments</span>
                                                    </div>
                                                </div>
                                            </div>
...
<footer class="page-footer">
                        ...
                        <div class="px-3">
                        Developed By: <a href="" target="">CROSS BORE</a>
                        </div>
...
function coversheetrealtime(mydata){
    var kk = $.ajax({
                                      url: "cover_sheet_saverealtime.php",
                                      type: "POST",
                                      dataType: "json",
                                      async: false,
                                      data: mydata
...
function ProjectDetailsrealtime(mydata){
    var kk = $.ajax({
                                      url: "ProjectDetailsSaveRealtime.php",
                                      type: "POST",
                                      dataType: "json",
                                      async: false,
                                      data: mydata
...
function QualifyingFiveRealdata(mydata){
    var kk = $.ajax({
                                      url: "ProjectDetailsSaveRealtime.php",
                                      type: "POST",
                                      dataType: "json",
...
function ChecklistQuestionsRealdata(mydata){
    var kk = $.ajax({
                                      url: "ProjectDetailsSaveRealtime.php",
                                      type: "POST",
                                      dataType: "json",
						  ...
						  if(Status){
							  return false;
                                    ...
                                    if ($('#SAP_Reviewed').is(":checked"))
                                     ...
                                     var Cross_Bore_Log_cmt = $("#Cross_Bore_Log_cmt").val();
                                ...
                                // }   
                                   ...
                                   ChecklistQuestions({Cross_Bore_Log_cmt:Cross_Bore_Log_cmt,order_no:order_no,id:reviewer_id,form_type:'ChecklistQuestions',SAP_Reviewed:SAP_Reviewed,SAP_Reviewed_cmt:SAP_Reviewed_cmt,Trenchless_MOI:Trenchless_MOI,Trenchless_MOI_cmt:Trenchless_MOI_cmt,
                                ...
                                */     
                                 if($('#CN29_in_SAP').is(":checked")==true){
                                  $('.submit').each(function() {
                                   ...
                                   if($('#MAT_check').is(":checked")==false){
                                      // alert('Please checked MAT');
                                       $("#errormat").css("display","block");
                                   }
                                   
                                    $('#MAT_check').change(function() {
                                    if(this.checked) {
                                        
                                       $("#errormat").css("display","none");
                                    }
                                   })
                                   if($('#CN24_check').is(":checked")==false){
                                       //alert('Please checked CN24_check');
                                        $("#errorcn24").css("display","");
                                   }
                                    $('#CN24_check').change(function() {
                                    if(this.checked) {
                                       $("#errorcn24").css("display","none");
                                    }
                                   })
                                   if($('#CN29_check').is(":checked")==false){
                                       //alert('Please checked CN29_check');
                                        $("#errorcn29").css("display","");
                                       
                                   }
                                    $('#CN29_check').change(function() {
                                    if(this.checked) {
                                       $("#errorcn29").css("display","none");
                                    }
                                   })
                                   if($('#CN07_check').is(":checked")==false){
                                      // alert('Please checked CN07_check');
                                        $("#errorcn07").css("display","");
                                   }
                                   $('#CN07_check').change(function() {
                                    if(this.checked) {
                                ...
                                //   })
                                   ...
                                   /*         Form Validation End            */  
                                   if ($('#MAT_check').is(":checked") && $('#CN24_check').is(":checked") && $('#CN29_check').is(":checked")&& $('#CN07_check').is(":checked"))
                                    {
                                         //alert('checked');
                                    }else{
									...
									return ProjectDetails({MAT_check:MAT_check,CN24_check:CN24_check,CN29_check:CN29_check,CN07_check:CN07_check,mat:mat,cn24:cn24,cn24_lanid:cn24_lanid, cn24_date:cn24_date,order_no:order_no,cn29:cn29, cn29_lanid:cn29_lanid, cn29_date:cn29_date,cn07:cn07, cn07_lanid:cn07_lanid, cn07_date:cn07_date,dc39:dc39, dc39_lanid:dc39_lanid, dc39_date:dc39_date,dc46:dc46, dc46_lanid:dc46_lanid, dc46_date:dc46_date,dc05:dc05, dc05_lanid:dc05_lanid, dc05_date:dc05_date,dc14:dc14, dc14_lanid:dc14_lanid, dc14_date:dc14_date,dc15:dc15, dc15_lanid:dc15_lanid, dc15_date:dc15_date,dc19:dc19, dc19_lanid:dc19_lanid, dc19_date:dc19_date,dc10:dc10, dc10_lanid:dc10_lanid, dc10_date:dc10_date,id:reviewer_id,cmt_cn_dc:cmt_cn_dc,form_type:'ProjectDetails'});
                                     /* var request = $.ajax({
                                      url: "ProjectDetailsSaveJS.php",
                                      type: "POST",
                                      data: {MAT_check:MAT_check,CN24_check:CN24_check,CN29_check:CN29_check,CN07_check:CN07_check,mat:mat,cn24:cn24,cn24_lanid:cn24_lanid, cn24_date:cn24_date,order_no:order_no,cn29:cn29, cn29_lanid:cn29_lanid, cn29_date:cn29_date,cn07:cn07, cn07_lanid:cn07_lanid, cn07_date:cn07_date,dc39:dc39, dc39_lanid:dc39_lanid, dc39_date:dc39_date,dc46:dc46, dc46_lanid:dc46_lanid, dc46_date:dc46_date,dc05:dc05, dc05_lanid:dc05_lanid, dc05_date:dc05_date,dc14:dc14, dc14_lanid:dc14_lanid, dc14_date:dc14_date,dc15:dc15, dc15_lanid:dc15_lanid, dc15_date:dc15_date,dc19:dc19, dc19_lanid:dc19_lanid, dc19_date:dc19_date,dc10:dc10, dc10_lanid:dc10_lanid, dc10_date:dc10_date,id:reviewer_id,cmt_cn_dc:cmt_cn_dc,form_type:'ProjectDetails'}
                                     });
...
// }
						  ...
						  if(Status){
							  return false;
                                ...
                                // }   
                                  ...
                                  var  jjj =  ChecklistQuestions({Cross_Bore_Log_cmt:Cross_Bore_Log_cmt,order_no:order_no,id:reviewer_id,form_type:'ChecklistQuestions',SAP_Reviewed:SAP_Reviewed,SAP_Reviewed_cmt:SAP_Reviewed_cmt,Trenchless_MOI:Trenchless_MOI,Trenchless_MOI_cmt:Trenchless_MOI_cmt,
                                             MOI_for_Srv:MOI_for_Srv,MOI_for_Srv_cmt:MOI_for_Srv_cmt,MOI_for_Main:MOI_for_Main,MOI_for_Main_cmt:MOI_for_Main_cmt,determine_the_MOI:determine_the_MOI,determine_the_MOI_cmt:determine_the_MOI_cmt
                                             ,used_to_retrieve_the_document:used_to_retrieve_the_document,used_to_retrieve_the_document_cmt:used_to_retrieve_the_document_cmt,SAP:SAP
                                             ,SAP_cmt:SAP_cmt,PRE_Inspection:PRE_Inspection,PRE_Inspection_cmt:PRE_Inspection_cmt,Post_Inspection_Required_per_PRE_Inspection:Post_Inspection_Required_per_PRE_Inspection,
                                              Post_Inspection_Required_per_PRE_Inspection_cmt:Post_Inspection_Required_per_PRE_Inspection_cmt,POST_Inspection:POST_Inspection,POST_Inspection_cmt:POST_Inspection_cmt,Cross_Bore_Log:Cross_Bore_Log
                                    ...
                                    /*  var request = $.ajax({
                                      url: "ProjectDetailsSaveJS.php",
                                      type: "POST",
                                      data: {Cross_Bore_Log_cmt:Cross_Bore_Log_cmt,order_no:order_no,id:reviewer_id,form_type:'ChecklistQuestions',SAP_Reviewed:SAP_Reviewed,SAP_Reviewed_cmt:SAP_Reviewed_cmt,Trenchless_MOI:Trenchless_MOI,Trenchless_MOI_cmt:Trenchless_MOI_cmt,
                                             MOI_for_Srv:MOI_for_Srv,MOI_for_Srv_cmt:MOI_for_Srv_cmt,MOI_for_Main:MOI_for_Main,MOI_for_Main_cmt:MOI_for_Main_cmt,determine_the_MOI:determine_the_MOI,determine_the_MOI_cmt:determine_the_MOI_cmt
                                             ,used_to_retrieve_the_document:used_to_retrieve_the_document,used_to_retrieve_the_document_cmt:used_to_retrieve_the_document_cmt,SAP:SAP
                                             ,SAP_cmt:SAP_cmt,PRE_Inspection:PRE_Inspection,PRE_Inspection_cmt:PRE_Inspection_cmt,Post_Inspection_Required_per_PRE_Inspection:Post_Inspection_Required_per_PRE_Inspection,
                                              Post_Inspection_Required_per_PRE_Inspection_cmt:Post_Inspection_Required_per_PRE_Inspection_cmt,POST_Inspection:POST_Inspection,POST_Inspection_cmt:POST_Inspection_cmt,Cross_Bore_Log:Cross_Bore_Log
	...
	if($("#Cross_Bore_Log_cmt").val() == ""){
		$("#Cross_Bore_Log_cmt").parent().find(".errorcmt").show();
		i=1;
	}
	else{
		$("#Cross_Bore_Log_cmt").parent().find(".errorcmt").hide();
	}
	if(i==1)
	{
	    return true;
...
<script>
 ...
 $("#cover_sheet").find('input,select,textarea').on('blur',function() {
	var order_no = $("#order_no").val();
	var datavalue = $(this).val();
	var datakey = $(this).attr('realtime');
	var reviewer_id = '<?php echo $userid  ?>';	
//  alert(datakey);
  var json1={datakey:datakey,datavalue:datavalue,order_no:order_no,reviewer_id:reviewer_id,
};
                                     //var review_date = $("#review_date").val();
                                     return coversheetrealtime(json1);
                                    
});

 $("#ProjectDetails").find('input,select,textarea').on('blur',function() {
  var order_no = $("#order_no").val();
  
                                
 var datakey = $(this).attr('id');
 if(datakey=='CN07_check' || datakey=='MAT_check' || datakey=='CN07_check' || datakey=='CN24_check' || datakey=='CN29_check'){
var datavalue = $(this).is(":checked");	 
 }else{ 
 	var datavalue = $(this).val();
...
var reviewer_id = '<?php echo $userid  ?>';	
 //  alert(datavalue);
var json1={datakey:datakey,datavalue:datavalue,order_no:order_no,reviewer_id:reviewer_id,form_type:'ProjectDetails',};
return ProjectDetailsrealtime(json1);
 });
 $('.mstp3 input[type=checkbox]').on('click', function () {
   var order_no = $("#order_no").val();
   var datakey = $(this).attr('id');
if(datakey=='CN29_in_SAP'){
 if ($(this).is(":checked"))
	{ 
	   var datavalue = '1'; 
	}else{
 ...
 var datavalue = $(this).val();
  ...
  var reviewer_id = '<?php echo $userid  ?>';
 var json1={datakey:datakey,datavalue:datavalue,order_no:order_no,reviewer_id:reviewer_id,form_type:'QualifyingFive',};
 return QualifyingFiveRealdata(json1);
 });
  $(".mstp3").find('input,select,textarea').on('blur',function() {
    var order_no = $("#order_no").val();
    var datakey = $(this).attr('id');
    var datavalue = $(this).val();
	var reviewer_id = '<?php echo $userid  ?>';
 ...
 $('.mstp4 input[type=checkbox]').on('click', function () {
   var order_no = $("#order_no").val();
   var datakey = $(this).attr('id');
if(datakey=='SAP_Reviewed'){
 if ($(this).is(":checked"))
	{ 
	   var datavalue = '1'; 
	}else{
 ...
 var datavalue = $(this).val();
  ...
  var reviewer_id = '<?php echo $userid  ?>';
 var json1={datakey:datakey,datavalue:datavalue,order_no:order_no,reviewer_id:reviewer_id,form_type:'ChecklistQuestions',};
 return ChecklistQuestionsRealdata(json1); 
 });
  $(".mstp4").find('input,select,textarea').on('blur',function() {
