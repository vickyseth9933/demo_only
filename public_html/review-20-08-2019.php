...
LEFT JOIN cb_front_cover ON(cb_front_cover.order_id='$order_no')
LEFT JOIN cb_project_details ON(cb_project_details.order_id='$order_no')
LEFT JOIN qualiflying_five ON(qualiflying_five.order_id='$order_no')
LEFT JOIN distribution_checklist ON(distribution_checklist.order_id='$order_no')
...
/*.datepicker::-webkit-datetime-edit, .datepicker::-webkit-LEFT-spin-button, .datepicker::-webkit-clear-button {*/
/*    display: none;*/
/*}*/
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text"  value="<?= htmlentities($row['cn24_lanid'], ENT_QUOTES); ?>" id="cn24_lanid" class="form-control" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  value="<?= htmlentities($row['cn29_lanid'], ENT_QUOTES); ?>" id="cn29_lanid" type="text" class="form-control" placeholder="">
                                                             </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['cn07_lanid'], ENT_QUOTES); ?>" id="cn07_lanid" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['dc39_lanid'], ENT_QUOTES) ?>" id="dc39_lanid" placeholder="">
                                                             </span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['dc46_lanid'], ENT_QUOTES); ?>" id="dc46_lanid" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['dc05_lanid'], ENT_QUOTES); ?>" id="dc05_lanid" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['dc14_lanid'], ENT_QUOTES); ?>" id="dc14_lanid" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['dc15_lanid'], ENT_QUOTES); ?>" id="dc15_lanid" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['dc19_lanid'], ENT_QUOTES); ?>" id="dc19_lanid" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group fild-width label-width">
                                                                ...
                                                                <span class="inlineInput">
                                                                <input  type="text" class="form-control" value="<?= htmlentities($row['dc10_lanid'], ENT_QUOTES); ?>" id="dc10_lanid" placeholder="">
                                                             </span>
                                                                <span class="inlineInput">
