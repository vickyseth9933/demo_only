 ...
 <footer class="page-footer">
   ...
   <!-- </div> -->
    ...
    <script src="assets/vendors/Flot/jquery.flot.resize.js"></script>
     <!--<script src="assets/vendors/Flot/jquerynew.flot.pie.js"></script>-->
    ...
    <?php
        ...
        if(in_array("1", $roleID)) { 
                ...
                <?php } 
                     ...
                     if($current_page == 'reviewer-dashboard.php') { ?>
...
@media print {
 ...
 <div id="printThis">
<div class="modal customModal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="content">
                        ...
                        <div class="container" id="prnct">					
                          ...
                          <div class="row padd-div">
                                 ...
                                 <div class="col-sm-12 col-md-8">
                                    <div class="form-group class-color_div">
                                      <textarea rows="2" id="2recommendation" readonly class="form-control bg-white" placeholder=""></textarea>
                                     </div>
                                 </div>
                              </div>
                              <div class="row padd-div 2reject_cmt">
                                 <div class="col-sm-8 col-md-4 align-self-center">
                                    <div class="form-group fild-width">
                                 ...
                                 <div class="col-sm-12 col-md-8">
                                    <div class="form-group class-color_div">
                                      <textarea rows="2" readonly id="2reject_cmt" class="form-control bg-white" placeholder=""></textarea>
                                     </div>
                                 </div>
                              </div>
						   </div>
...
<!-- QUICK SIDEBAR-->
      ...
      <!--      <li class="nav-item">-->
      <!--         <h6 class="dropdown-header m-0"><span class="grey darken-2">Notifications</span><span class="notification-tag badge badge-default badge-danger text-white float-right m-0">5 New</span></h6>-->
      <!--      </li>-->
      <!--   </ul>-->
      <!--   <div class="tab-content">-->
      <!--      <div class="tab-pane chat-panel active" id="notification-list">-->
      <!--         <div class="chat-list">-->
      <!--            <div class="scroller">-->
      <!--               <div class="media-list">-->
      <!--                  <a class="media" href="javascript:;">-->
      <!--                     <div class="media-img align-self-center">-->
      <!--                        <span class="notificationImg"><img src="/profile_image/<?php echo $profileimg;?>" /></span>-->
      <!--                     </div>-->
      <!--                     <div class="media-body">-->
      <!--                        <div class="report-div">-->
                                 <!--<a href="#" title="#" class="review-report">Review Report</a>-->
      <!--                           <small class="float-right text-muted">12:05</small>-->
      <!--                        </div>-->
      <!--                        <div class="media-heading">Lorem ipsum dolor sit amet, consectetuer elit.-->
      <!--                           <span class="notification-id">Project ID-0123456</span>-->
      <!--                        </div>-->
      <!--                     </div>-->
      <!--                  </a>-->
      <!--                  <a class="media" href="javascript:;">-->
      ...
      <!--                     <div class="media-body">-->
      <!--                        <div class="report-div">-->
      <!--                           <small class="float-right text-right text-success">-->
      <!--                           <i class="badge-point badge-success mr-2"></i>12:05 -->
      <!--                           <span class="notification-Msg badge badge-danger badge-circle">3</span>-->
      <!--                           </small>-->
      <!--                        </div>-->
      <!--                        <div class="media-heading">Lorem ipsum dolor sit amet, consectetuer elit.-->
      <!--                           <span class="notification-id">Project ID-0123456</span>-->
      ...
      <!--                           <small class="float-right text-right text-success">-->
      <!--                           <i class="badge-point badge-success mr-2"></i>12:05 -->
      <!--                           <span class="notification-Msg badge badge-danger badge-circle">1</span>-->
      <!--                           </small>-->
      <!--                        </div>-->
      <!--                        <div class="media-heading">Lorem ipsum dolor sit amet, consectetuer elit.-->
      <!--                           <span class="notification-id">Project ID-0123456</span>-->
 ...
 */
    ...
    <script>
        	$(document).ready(function(){
               ...
               if (pathname.includes("manage-role")) {
                //alert("ok");
                $(".dropdown-menu").find(".dropdown-item:nth-child(3)").addClass("active");
                }
                else if (pathname.includes("manage-member2")) {
                //alert("ok");
                $(".dropdown-menu").find(".dropdown-item:nth-child(2)").addClass("active");
                $("#admn").addClass("active");
                }
                else if (pathname.includes("pie_chart_report")) {
                 $(".dropdown-menu").find(".dropdown-item:nth-child(4)").addClass("active");
                $("#admn").addClass("active");
                }
                 else if (pathname.includes("edit_profile")) {
                //alert("ok");
                $(".dropdown-menu").find(".dropdown-item:nth-child(5)").addClass("active");
                $("#admn").addClass("active");
                }
                else if (pathname.includes("my_profile")) {
               // alert("ok");
               $("#admn").addClass("active");
                //$(".dropdown-header").find("a").addClass("active");
                }
                else{
