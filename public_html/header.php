            ...
            <div class="flexbox flex-1 navbar navbar-expand-md navbar-light py-0 pr-md-0">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExample05">
                    <ul class="nav navbar-toolbar">
                        ...
                        ?>
                        <li>
                            <a href="review-form.php"><i class="sidebar-item-icon fa fa-eye"></i><span class="nav-label">View Form</span></a>
                        </li>
                        <?php } ?>
                    <!--    <li class="dropdown dropdown-notification">-->
                    <!--        <a class="nav-link quick-sidebar-toggler" data-toggle="dropdown" href="javascript:;"><i class="fa fa-bell-o"></i>-->
                    <!--            <span class="envelope-badge">5</span>-->
                    <!--        </a>-->
                    ...
                    <!--</li>-->
                        ...
                        <li class="dropdown dropdown-user">
                            <a class="nav-link dropdown-toggle link flex-row-reverse flex-md-row flex-start justify-content-end" data-toggle="dropdown">
                                <span id="admn"><?php echo $profile_name; ?></span>
                                <?php if($profileimg) { ?>
                            ...
                            <div class="dropdown-menu dropdown-arrow dropdown-menu-right admin-dropdown-menu mr-md-1 mdropdown">
                                ...
                                <?php
                                 ...
                                 <a class="dropdown-item" href="pie_chart_report.php"><i class="fa fa-pie-chart"></i>Pie Chart Report</a>
                                 <a class="dropdown-item" href="ConsolidatedExcel.php"><i class="fa fa-pie-chart"></i>Consolidated Excel</a>
                                <a class="dropdown-item" href="update-weekly-report.php"><i class="fa fa-pie-chart"></i>Update Weekly Report</a>
                                    <?php } ?>  
