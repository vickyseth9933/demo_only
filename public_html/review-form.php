...
$order_id = base64_decode('31147190');
$idd = '31147190';
if($idd=='')
{
header("Location: ".$serverLink."admin-dashboard.php");    
}
                                 ...
                                 <div class="modal-body">
                                    ...
                                    <form class="editForm" action="#" method="post">
                                        ...
                                        <span class="errorcmtrecom" style="display:none;color:red;">Please Select Recommendation</span>                    
                                            ...
                                            <a class="disable"><span>Send For Approval</span></a>
                                            <a class="disable"><span>My Dashboard</span></a>
                                        </div>
                                    </form>
                                </div>
...
function ProjectDetails(mydata){
    var kk = $.ajax({
                                      url: "projectdetaislssavedemo.php",
                                      type: "POST",
                                      dataType: "json",
                                      async: false,
                                      data: mydata
...
// }
    ...
    function RestartReview() {
      ...
      var request = $.ajax({
                                    ...
                                    request.done(function(msg) {
                                    //alert(msg.status);    
                                    setTimeout(function(){ window.location.href="admin-dashboard.php"; }, 5000);
                                            ...
                                            if(data.status_message=='Success'){
                                             //    alert(data.status_message);
                                                ...
                                                $('#modalRegisterForm .close').click();
                                                    ...
                                                    //window.location.replace("https://crossqafinal.epiksolution.org/admin-dashboard.php");
                                                    //$('#gotorev').click();
