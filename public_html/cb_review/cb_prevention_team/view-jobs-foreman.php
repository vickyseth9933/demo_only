...
$sql="select DISTINCT cb_front_cover.foreman from cb_front_cover 
                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <div class="row">
									<div class="col-sm-12">
										<h5 class="table-heading mb-4"> <i class="fa fa-caret-down"></i> <?php echo $row['foreman']; ?>  Jobs</h5>
									</div>
                                </div>
                                        <div class="tble_wrp">
                                            <table class="table table-bordered table-hover datatable">
                                                ...
                                                <tbody>
                                            <?php 
                                            $forman = $conn->real_escape_string($row['foreman']);
                                            $show_que = "SELECT cb_front_cover.city as CITY,order_status.order_name,cb_order_new.order_no,cb_order_new.recommendation,cb_order_new.user_id,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat,cb_front_cover.division,cb_front_cover.foreman FROM cb_order_new 
...
WHERE cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.foreman = '".$forman."'";
                                           ...
                                           while($show_row = $show_res->fetch_array()){
                                            ?>
                                                    ...
                                                    <input type="hidden" name="memid" value="<?php echo $show_row['user_id'];?>" id="hiddenuserid">
                                                     ...
                                                     <td><?php echo $show_row['foreman']; ?></td> 
