...
WHERE order_status.order_name = 'CN-29 Eligible' AND  order_stage = 6 AND send_job_approval='1' AND cb_order_new.approved_date >= '$today' AND cb_order_new.approved_date <= '$nxt7day'";
