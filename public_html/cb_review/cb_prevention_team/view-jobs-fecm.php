...
$sql="select DISTINCT cb_front_cover.fc_cm from cb_front_cover 
                      ...
                      <div class="navBreadcrumb">
                          <ol class="breadcrumb">
                              <li class="breadcrumb-item">
                                  <a href="/cb_review/cb_prevention_team/view-jobs.php">View Jobs</a>
                                 </li>
                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <div class="row">
									<div class="col-sm-12">
										<h5 class="table-heading mb-4"> <i class="fa fa-caret-down"></i> <?php echo $row['fc_cm']; ?>  Jobs</h5>
									</div>
                                </div>
                                        <div class="tble_wrp">
                                            <table class="table table-bordered table-hover datatable">
                                                ...
                                                <tbody>
                                            <?php 
                                            $fccm = $conn->real_escape_string($row['fc_cm']);
                                            ...
                                            cb_project_details.mat,cb_front_cover.division,cb_front_cover.fc_cm FROM cb_order_new 
                                            ...
                                            WHERE cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.fc_cm = '".$fccm."'";
