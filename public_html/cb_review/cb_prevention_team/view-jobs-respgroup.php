...
$sql="select DISTINCT cb_front_cover.resp_group from cb_front_cover 
                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <div class="row">
									<div class="col-sm-12">
										<h5 class="table-heading mb-4"> <i class="fa fa-caret-down"></i> <?php echo $row['resp_group']; ?>  Jobs</h5>
									</div>
                                </div>
                                        <div class="tble_wrp">
                                            <table class="table table-bordered table-hover datatable">
                                                ...
                                                <tbody>
                                            <?php 
                                            $resgrp = $conn->real_escape_string($row['resp_group']);
                                            ...
                                            WHERE cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.resp_group = '".$resgrp."'";
