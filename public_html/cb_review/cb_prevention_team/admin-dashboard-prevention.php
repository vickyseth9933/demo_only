...
if($type == 'Eligible'){
 ...
 $sqljob_cn29 = "SELECT cb_order_new.approved_date,cb_order_new.RESPONSIBLE_GROUP,cb_order_new.MAT as MAAT,cb_order_new.description as cb_desc,cb_order_new.order_no,cb_order_new.user_id,cb_order_new.recommendation,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
...
WHERE order_status.order_name = 'CN-29 Eligible' AND  order_stage = 6 AND send_job_approval='1' AND cb_order_new.approved_date >= '$today' AND cb_order_new.approved_date <= '$enddate'";
...
LEFT JOIN cb_order ON(cb_order.order_id=cb_order_new.order_no)
LEFT JOIN  order_status ON(cb_order.status=order_status.id)
WHERE order_status.order_name = 'CN-29 Eligible' AND  order_stage = 6 AND send_job_approval='1'"; 
...
if($type == 'Remediation'){
 ...
 $sqljob_field_remedtn = "SELECT cb_order_new.approved_date,cb_order_new.RESPONSIBLE_GROUP,cb_order_new.MAT as MAAT,cb_order_new.description as cb_desc,cb_order_new.order_no,cb_order_new.user_id,cb_order_new.recommendation,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat FROM cb_order_new 
INNER JOIN cb_user ON(cb_order_new.user_id=cb_user.id)
LEFT JOIN cb_front_cover ON(cb_front_cover.order_id=cb_order_new.order_no)
LEFT JOIN cb_project_details ON(cb_project_details.order_id=cb_order_new.order_no)
...
WHERE order_status.order_name = 'Field Remediation Required' AND  send_job_approval='1'  AND order_stage = 6  AND cb_order_new.approved_date >= '$today' AND cb_order_new.approved_date <= '$enddate'";  
 ...
 $sqljob_field_remedtn = "SELECT cb_order_new.description as cb_desc,cb_order_new.RESPONSIBLE_GROUP,cb_order_new.MAT as MAAT,cb_order_new.approved_date,cb_order_new.order_no,cb_order_new.user_id,cb_order_new.recommendation,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat FROM cb_order_new 
INNER JOIN cb_user ON(cb_order_new.user_id=cb_user.id)
LEFT JOIN cb_front_cover ON(cb_front_cover.order_id=cb_order_new.order_no)
LEFT JOIN cb_project_details ON(cb_project_details.order_id=cb_order_new.order_no)
...
if($type == 'Unknown') {
 $sqljob_unknown_status = "SELECT cb_order_new.description as cb_desc,cb_order_new.RESPONSIBLE_GROUP,cb_order_new.MAT as MAAT,cb_order_new.approved_date,cb_order_new.order_no,cb_order_new.user_id,cb_order_new.recommendation,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat FROM cb_order_new 
INNER JOIN cb_user ON(cb_order_new.user_id=cb_user.id)
LEFT JOIN cb_front_cover ON(cb_front_cover.order_id=cb_order_new.order_no)
LEFT JOIN cb_project_details ON(cb_project_details.order_id=cb_order_new.order_no)
...
$sqljob_unknown_status = "SELECT cb_order_new.description as cb_desc,cb_order_new.RESPONSIBLE_GROUP,cb_order_new.MAT as MAAT,cb_order_new.approved_date,cb_order_new.order_no,cb_order_new.recommendation,cb_order_new.user_id,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat FROM cb_order_new 
INNER JOIN cb_user ON(cb_order_new.user_id=cb_user.id)
LEFT JOIN cb_front_cover ON(cb_front_cover.order_id=cb_order_new.order_no)
LEFT JOIN cb_project_details ON(cb_project_details.order_id=cb_order_new.order_no)
...
$( function() {
    ...
    var type='Eligible';
    window.location.href="admin-dashboard-prevention.php?date="+startDat+"&enddate="+Enddate+"&type="+type;
    }
    });
    });
//   $( function() {
...
//   } );
  ...
  function datefun(date,type){
      //alert(type);
       window.location.href="admin-dashboard-prevention.php?date="+date+"&type="+type;
//   $.ajax({
...
.w15 {
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="ibox">
                            <div class="ibox-body">
                                <h2 class="ibox-title">Dashboard</h2>
                                <div class="row">
									<div class="col-sm-12">
                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
										...
										<div class="flexbox control-div mb-2">
											<!--<div class="flexbox">-->
											<!--	<label class="mb-0 pr-2 ml-0 w15">Select Date:</label>-->
											...
											<div class="flexbox">
												...
												<input type="text" class="selectpicker show-tick form-control selectpickerdiv2" onChange="datefun(datepicker.value,'Eligible')" id="datepicker" title="Please select date" data-style="btn-solid" data-width="150px" value="<?php if($type == 'Eligible') { echo $data. ' - ' .$enddate1; }  ?>">
											</div>
										</div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="table-responsive">
											...
											?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['name']; ?></td>
                                                        <td><?= $row['order_no']; ?></td>
                                                        <td><?php if($row['description']==''){ echo $row['cb_desc']; }else{ echo $row['description'];}; ?></td>
                                 ...
                                 <div class="row">
                                        <div class="col-sm-12">
                                             ...
                                             <?php if($type == 'Eligible') { ?>
                                              <a href="../ExcelGenerate.php?type=eligible&date_value=<?php  echo $data;   ?>&enddate=<?php  echo $enddate;   ?>"  class="btn btn-primary approvediv-colorr">Download Weekly Excel</a>
                                              <?php } else { ?>
                                    ...
                                    <div class="col-sm-12">
										...
										<?php
											...
											<tr>
                                                ...
                                                <td><?php if($rowjobstatus['description']!=''){ echo $rowjobstatus['description']; }else{ echo $rowjobstatus['cb_desc'];}?></td>
                                                ...
                                                <td><?php echo date('m-d-Y', strtotime($rowjobstatus['approved_date'])); ?></td>
 ...
 <div class="row">
     <div class="col-sm-12">
                                ...
                                <?php if($type == 'Remediation') { ?>
                                <a href="../ExcelGenerate.php?type=remediation&date_value=<?php  echo $data;   ?>&enddate=<?php  echo $enddate;   ?>"  class="btn btn-primary approvediv-colorr">Download Weekly Excel</a>
                               <?php } else { ?>
                            ...
                            <div class="ibox-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
										...
										<?php
											...
											<tr>
                                                ...
                                                <td><?php echo date('m-d-Y', strtotime($rownotjobstart['approved_date'])); ?></td>
                                 ...
                                 <div class="row">
                                        ...
                                        <?php if($type == 'Unknown') { ?>
                                         <a href="../ExcelGenerate.php?type=unknown&date_value=<?php  echo $data;  ?>&enddate=<?php  echo $enddate;   ?>"  class="btn btn-primary approvediv-colorr">Download Weekly Excel</a>
                                        <?php } else { ?>
         ...
         <?php include('../footer_review.php');  ?> 
           <!--<script src="https://crossfinal.epiksolution.org/cb_review/crossbore_main.js"></script>-->
