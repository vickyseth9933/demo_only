...
$sqljob_distributn = "SELECT order_status.order_name,cb_order_new.order_no,cb_front_cover.order_description as description,cb_order_new.user_id,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
...
WHERE cb_order_new.TRANS_DIST = 'DISTRIBUTION'";
$result_distributn = $conn->query($sqljob_distributn);


$sqljob_transmission = "SELECT order_status.order_name,cb_order_new.order_no,cb_order_new.user_id,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat FROM cb_order_new 
INNER JOIN cb_user ON(cb_order_new.user_id=cb_user.id)
INNER JOIN cb_front_cover ON(cb_front_cover.order_id=cb_order_new.order_no)
INNER JOIN cb_project_details ON(cb_project_details.order_id=cb_order_new.order_no)
INNER JOIN cb_order ON(cb_order.order_id=cb_order_new.order_no)
INNER JOIN  order_status ON(cb_order.status=order_status.id)
WHERE cb_order_new.TRANS_DIST = 'TRANSMISSION'";
                                        ...
                                        <div class="table-responsive">
											...
											?>
                                                    <tr>
                                                     ...
                                                     <td><?php echo $row_distributn['description']; ?></td>  
                                                     <td><?php echo $row_distributn['resp_group']; ?></td>  
                                                     <td><?php echo $row_distributn['mat']; ?></td>  
                                                     <td><?php echo $row_distributn['order_name']; ?></td>  
