...
<div id="printThis">
    <div class="container">
<div class="modal fade bd-example-modal-lg customModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="content">
									   ...
									   <div class="row p-0">
											...
											<div class=" col-1">
												 <div class="custom-control custom-checkbox ml-4">
													 ...
													 <label class="custom-control-label checkdivclass add-class-div" readonly for="Checkmat"></label>
												  </div>
											</div>
									   </div>                             
