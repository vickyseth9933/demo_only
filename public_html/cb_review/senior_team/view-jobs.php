...
LEFT JOIN cb_front_cover ON(cb_project_details.order_id = cb_front_cover.order_id) 
LEFT JOIN cb_order_new ON(cb_order_new.order_no = cb_project_details.order_id) 
LEFT JOIN cb_order ON(cb_order.order_id = cb_project_details.order_id) 
...
LEFT JOIN cb_project_details ON(cb_front_cover.order_id = cb_project_details.order_id)
LEFT JOIN cb_order_new ON(cb_order_new.order_no = cb_project_details.order_id)
LEFT JOIN cb_order ON(cb_order.order_id = cb_project_details.order_id)
LEFT JOIN order_status ON(cb_order.status =order_status.id) where cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.resp_group != ''";
...
LEFT JOIN cb_order_new ON(cb_order_new.order_no = cb_project_details.order_id)
LEFT JOIN cb_order ON(cb_order.order_id = cb_project_details.order_id)
LEFT JOIN order_status ON(cb_order.status =order_status.id) where cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.division != ''";
...
LEFT JOIN cb_order_new ON(cb_order_new.order_no = cb_project_details.order_id)
LEFT JOIN cb_order ON(cb_order.order_id = cb_project_details.order_id)
LEFT JOIN order_status ON(cb_order.status =order_status.id) where cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.fc_cm != ''";
...
LEFT JOIN cb_order_new ON(cb_order_new.order_no = cb_project_details.order_id)
LEFT JOIN cb_order ON(cb_order.order_id = cb_project_details.order_id)
LEFT JOIN order_status ON(cb_order.status =order_status.id) where cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.foreman != ''";
...
LEFT JOIN cb_order_new ON(cb_order_new.order_no = cb_project_details.order_id)
LEFT JOIN cb_order ON(cb_order.order_id = cb_project_details.order_id)
LEFT JOIN order_status ON(cb_order.status =order_status.id) where cb_order_new.send_job_approval='1' AND order_stage= 6 AND cb_front_cover.inspector != ''";
...
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="/cb_review/senior_team/snr_dashboard.php">Home</a></li>
...
<li><a href="/cb_review/senior_team/view-jobs-matcode.php" title="Mat Code Jobs"> Mat Code Jobs (<?php echo $crow[0]; ?>)</a></li>
<li><a href="/cb_review/senior_team/view-jobs-respgroup.php" title="Resp Group Jobs"> Resp Group Jobs (<?php echo $resp_row[0]; ?>)</a></li>
<li><a href="/cb_review/senior_team/view-jobs-division.php" title="Division Jobs"> Division Jobs (<?php echo $div_row[0]; ?>)</a></li>
<li><a href="/cb_review/senior_team/view-jobs-fecm.php" title="FE/CM Jobs"> FE/CM Jobs (<?php echo $fe_row[0]; ?>)</a></li>
<li><a href="/cb_review/senior_team/view-jobs-foreman.php" title="Forman Jobs"> Foreman Jobs (<?php  echo $forman_row[0]; ?>)</a></li>
<li><a href="/cb_review/senior_team/view-jobs-inspector.php" title="Inspector Jobs"> Inspector Jobs (<?php echo $isp_row[0]; ?>)</a></li>
</ul>
</div>
                           </div>
                        </div>
