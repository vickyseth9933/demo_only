...
$result_job = $conn->query($sqljob_data);
                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            <div class="ibox-body">
                                <div class="row">
									<div class="col-sm-12">
										<h5 class="font-strong mb-4">All Jobs</h5>
									</div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
                                        ...
                                        <div class="flexbox control-div mb-4">
                                            ...
                                            <select class="selectpicker show-tick form-control" id="filterdata" title="Please select" onchange="addFun(this.value)" data-style="btn-solid" data-width="150px">
                                            <option value="City_Division">City/Division</option>
                                            <option value="cn24_date">CN-24 completed</option>
                                            ...
                                            <input type="text" onChange="datefun(this.value)" id="dateinp" class="datepicker"  style="display: none;" />
                                            <input type="text" id="roleinp" class=""  style="display: none;" />
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <?php
                                             $i=1;       	
											while($row = $result_job->fetch_array()) {
...
$(document).ready(function(){
  ...
  function datefun(date,type){
      alert(date);
       window.location.href="job-filter.php?date="+date;
//   $.ajax({
