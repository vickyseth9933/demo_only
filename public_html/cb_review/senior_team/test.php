                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
										...
										<div class="flexbox control-div mb-2">
											<div class="flexbox">
												...
												<select class="selectpicker show-tick form-control selectpickerdiv2" id="type-filtercn29" onchange="get_cn29_weekdata()" title="Please select" data-style="btn-solid" data-width="150px">
													<option value="">All</option>
													<option value="CN-29 Eligible">Weekly</option>
													<option value="Field Remediation Required">Monthly</option>
													<option value="Unknown Status">Custom Date</option>													
												</select>
											</div>
										</div>
                            ...
                            <div class="ibox-body">
                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
                                        ...
                                        <div class="flexbox control-div mb-2">
                                            <div class="flexbox">
                                                <label class="mb-0 pr-2 ml-0">Status:</label>
                                                <select class="selectpicker show-tick form-control" id="type-filter2" onchange="get_fieldremedation_weekdata()" title="Please select" data-style="btn-solid" data-width="150px">
                                                    <option value="">All</option>
													<option value="CN-29 Eligible">Weekly</option>
													<option value="Field Remediation Required">Monthly</option>
													<option value="Unknown Status">Custom Date</option>
