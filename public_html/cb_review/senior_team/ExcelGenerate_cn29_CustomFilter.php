...
if(isset($_REQUEST['jobstatusr'])){


    
    if($_REQUEST['jobstatusr'] == 'cn29_eligible'){
        
      $datatype = "CN-29 Eligible";
        
    } if($_REQUEST['jobstatusr'] == 'fieldremedation'){
        
       $datatype = "Field Remediation Required";
    } 
    if($_REQUEST['jobstatusr'] == 'unknownstatus'){
...
//echo "<pre>";print_r($_GET);
   //echo $_GET['filter'];
   //echo $_GET['jobstatusr'];
if($_REQUEST['filter']=='' &&  $_REQUEST['jobstatusr']=='cn29_eligible'){
    //echo "hfggh";
    /*echo $sqljob_cn29 = "SELECT cb_order_new.approved_date,cb_order_new.order_no,cb_order_new.user_id,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
...
$column = 'A';
$rowCount = 2;  
if ($result = $conn->query($sqljob_cn29)) {
