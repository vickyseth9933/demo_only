...
$sqljob_field_remedtn = "SELECT order_status.order_name,cb_order_new.order_no,cb_order_new.user_id,cb_order_new.order_stage,CONCAT(cb_user.first_name, ' ' , cb_user.last_name)  as name,cb_front_cover.order_description as description,cb_front_cover.resp_group,
cb_project_details.mat FROM cb_order_new 
INNER JOIN cb_user ON(cb_order_new.user_id=cb_user.id)
INNER JOIN cb_front_cover ON(cb_front_cover.order_id=cb_order_new.order_no)
INNER JOIN cb_project_details ON(cb_project_details.order_id=cb_order_new.order_no)
                            ...
                            <div class="ibox-body">
                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
										...
										<div class="flexbox control-div mb-2">
										    <input type="hidden" name="jstatus" class="job_status" value="cn29_eligible">
											<div class="flexbox">
                                            ...
                                            <div style="display:none" class="form-group month_year" id="month_year">
                                                <div class='input-group date' id=''>
                                                 <input class="form-control datepicker" name="" id="monthly" type="text">

                                                </div>
                                            </div>
                                             <div style="display:none" class="form-group date_range" id="date_range">
                                                <div class='input-group date' id=''>
                                                <label for="from">From</label>
                                                <input class="" type="text" id="from" name="from">
                                                <label for="to">to</label>
                                                <input class="" type="text" id="to" name="to">

                                                </div>
                                            </div>
                                            <div style="display:none" class="form-group weekly" id="weekly">
                                                <div class='input-group date' id=''>
                                                <input class="form-control datepicker3"  name="weekdays" id="week" type="text">
                                                </div>
                                            </div>
                        ...
                        <div class="ibox">
                            <div class="ibox-body">
                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
                                        ...
                                        <div class="flexbox control-div mb-2">
                                            <input type="hidden" name="jstatus" class="job_status" value="field_remedation">
                                            <div class="flexbox">
                                                <label class="mb-0 pr-2 ml-0">Status:</label>
                                                <select class="selectpicker show-tick form-control" id="type-filter2" onchange="get_fieldremedation_weekdata(this.value)" title="Please select" data-style="btn-solid" data-width="150px">
                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            <div class="ibox-body">
                                ...
                                <div class="d-flex justify-content-between flexible-status-search">
                                        <input type="hidden" name="jstatus" class="job_status" value="unknown_status">
                                        <div class="flexbox control-div mb-2">
                                            <div class="flexbox">
                                                <label class="mb-0 pr-2 ml-0">Status:</label>
                                                <select class="selectpicker show-tick form-control" id="type-filter3" onchange="get_unknownstatus_weekdata()" title="Please select" data-style="btn-solid" data-width="150px">
                                                    <option value="">All</option>
													<option value="week">Weekly</option>
													<option value="month">Monthly</option>
													<option value="custom">Custom Date</option>		
     ...
     if(value=='month'){
      ...
      if(value=='custom'){
       ...
       if(value=='All'){
         ...
         $('.weekly').hide();
        $('.date_range').hide();
        window.location.href="review_report.php";
...
/*function get_fieldremedation_weekdata() {
  alert('edfr');
          $.ajax({
            type: 'post',
            url: 'fetch_fieldremedation.php',
            data: $('form').serialize(),
            error: function(xhr, status, error) {
            var err = eval("(" + xhr.responseText + ")");
            alert(err.Message);
            ...
            success: function (data) {
                 $("#field_remedation").hide();
                 $("#dash_datatable2").append(data);
            }
...
function get_unknownstatus_weekdata() {
  alert('edfr');
          $.ajax({
            type: 'post',
            url: 'fetch_unknownstatus.php',
            data: $('form').serialize(),
            error: function(xhr, status, error) {
            var err = eval("(" + xhr.responseText + ")");
            alert(err.Message);
...
$(function() {
	$('.datepicker').datepicker({
        ...
        var type = 'month';
                var dateText2 = $('#monthly').val();
                var dateText2 = $.trim(dateText2);
                var str = dateText2.replace(/\s/g, '');
                window.location.href="review_report.php?filter="+type+"&monthyear="+str;
		});
  ...
  $( function() {
    ...
    function getDate( element ) {
      ...
      try {
       ...
       if(sdate!='' && enddate!=''){
      var type = 'week';
     window.location.href="review_report.php?filter="+type+"&sdate="+sdate+"&enddate="+enddate;
      }
      return date;
    }
  } );
   ...
   $('.datepicker3').datepicker({
    ...
    var Enddate = $.datepicker.formatDate( dateFormat, endDate, inst.settings );
     $(this).val($.datepicker.formatDate( dateFormat, startDate, inst.settings ) + " - " + $.datepicker.formatDate( dateFormat, endDate, inst.settings ));
      var type = 'week';
      var job_status_val = $( ".job_status" ).val();
     window.location.href="review_report.php?filter="+type+"&sdate="+startDat+"&enddate="+Enddate+"&jobstatus="+job_status_val;
      var data_filter = 'filter=week&sdate='+startDat+'&enddate='+Enddate;
        //   $.ajax({
        //     type: 'post',
        //     url: 'fetch_cn29data.php',
        //     //data: $('form').serialize(),
