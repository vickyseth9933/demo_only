...
{
    $homeurl = '/cb_review/cb_prevention_team/admin-dashboard-prevention.php';
}
// else{
            ...
            <div class="flexbox flex-1 navbar navbar-expand-md navbar-light py-0 pr-md-0">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExample05">
                    <ul class="nav navbar-toolbar">
                        ...
                        ?>
                        <li>
                            <a href="/cb_review/cb_prevention_team/admin-dashboard-prevention.php"><i class="sidebar-item-icon fa fa-share-square-o"></i><span class="nav-label">Dashboard</span></a>
                        </li>
                        
                          <li>
                            <a href="/cb_review/cb_prevention_team/checklist-questionnaire-prevention.php"><i class="sidebar-item-icon fa fa-share-square-o"></i><span class="nav-label">Questionnaire</span></a>
                        </li>
                        
                         <li>
                            <a href="/cb_review/cb_prevention_team/view-jobs.php"><i class="sidebar-item-icon fa fa-share-square-o"></i><span class="nav-label">View Jobs</span></a>
                        </li>
                        <?php } ?>
